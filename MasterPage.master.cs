    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (objCurrentCustomer != null && objCurrentCustomer.mobile != null && objCurrentCustomer.mobile.Length > 1)
            {
                ...
                lbllogout.InnerHtml = "<li><a href=\"PersonalInfo.aspx\" style=\"color:#1DA1F2;\">Personal Information</a></li><li><a href=\"MyWallet.aspx\" style=\"color:#1DA1F2;\">My Wallet</a></li>  <li><a href=\"MyOrder.aspx\" style=\"color:#1DA1F2;\">My Orders</a></li><li><a href=\"Franchisee.aspx\" style=\"color:#1DA1F2;\">Become a Franchisee</a></li><li><p><span><a href=\"Logout.aspx\" id=\"logoutiddd\" style=\"color:#1DA1F2;\">LogOut</a></span></p></a></li>";
            }
            else
            {
                //lbloo.Visible = false;
                ...
                if (!string.IsNullOrWhiteSpace(Request.QueryString["fcode"]))
                {
                    lbllogout.InnerHtml = "<li><a href='register.aspx?fcode=" + Request.QueryString["fcode"] + "' style='color:#1DA1F2;'>Login</a></li>";
                }
                else
                {
                    lbllogout.InnerHtml = "<li><a href='register.aspx' style='color:#1DA1F2;'>Login</a></li>";
